...
helplen	equ	$-helpmsg
err1msg	db	"Coundn't open source file for reading", 10
err1len equ	$-err1msg
...
_start:
		...
		cmp dword [argc], 3
		je .args_count_ok
		kernel 4, 2, helpmsg, helplen ; write in strerr
		kernel 1, 1                   ; exit 1	
.args_count_ok:
...
again:
		kernel 3, [fdsrc], buffer, bufsize ; read fron src
		cmp eax, 0
		jle .end_of_file
		kernel 4, [fddest], buffer, eax    ; write to dest
		jmp again
